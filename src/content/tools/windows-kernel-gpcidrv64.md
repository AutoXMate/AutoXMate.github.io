...
execution:
  template: sc.exe create gpcidrv64.sys binPath=C:\windows\temp\gpcidrv64.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create gpcidrv64.sys binPath=C:\windows\temp\gpcidrv64.sys type=kernel
    && sc.exe start gpcidrv64.sys
references:
- label: Reference
