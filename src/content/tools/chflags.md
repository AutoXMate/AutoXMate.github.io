...
execution:
  ...
  shell: false
examples:
- description: "Hide a file: Add the hidden flag to a file or directory to prevent\
    \ it from being \nvisible in Finder and Terminal."
  command: chflags hidden ~/evil
- description: 'Remove hidden flag: Remove the hidden flag to a file or directory
