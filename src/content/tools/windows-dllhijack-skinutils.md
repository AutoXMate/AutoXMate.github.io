...
id: windows-dllhijack-skinutils
namespace: windows:dllhijack:skinutils
name: skinutils.dll
description: "skinutils.dll — Sideloading hijacking (ICQ)"
...
references:
  ...
  - label: "HijackLibs"
    url: "https://hijacklibs.net/entries/skinutils.html"
---
examples:
  - description: "Place malicious skinutils.dll in the search order location"
    command: "copy malicious.dll \"%PROGRAMFILES%\\ICQLite\\skinutils.dll\""
