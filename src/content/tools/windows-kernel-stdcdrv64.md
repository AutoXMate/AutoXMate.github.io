---
id: windows-kernel-stdcdrv64
namespace: windows:kernel:stdcdrv64
name: stdcdrv64.sys
...
execution:
  template: sc.exe create stdcdrv64sys binPath= C:\windows\temp\stdcdrv64sys.sys type=kernel
...
install:
- method: custom
  description: Load stdcdrv64.sys kernel driver
  commands:
  - sc.exe create stdcdrv64sys binPath= C:\windows\temp\stdcdrv64sys.sys type=kernel
    && sc.exe start stdcdrv64sys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create stdcdrv64sys binPath= C:\\\\windows\\\\temp\\\\stdcdrv64sys.sys type=kernel && sc.exe start stdcdrv64sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver stdcdrv64.sys"
