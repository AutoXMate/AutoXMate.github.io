...
name: dnsrecon
description: DNS enumeration script that performs SRV record discovery, subdomain
  bruteforce, DNSSEC testing, zone transfer attempts, and reverse DNS lookups.
...
- name: flag-dnsserver
  ...
  - --dnsserver
execution:
  template: dnsrecon {flag-type} {flag-threads} {flag-csv} {flag-json} {flag-db} {flag-dnsserver}
    {flag-range} {flag-nameserver} {flag-dictionary} {domain}
  sandbox: execFile
  timeout_seconds: 300
  shell: false
examples:
