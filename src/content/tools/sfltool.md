...
execution:
  ...
  shell: false
examples:
- description: 'Display Login Items: Identify all current login and background items
    configured on the system.'
  command: sfltool dumpbtm
- description: 'Reset Login Items to Defaults: Reset all third-party Login Items and
    revert to installation defaults.'
...
- type: other
  ...
  description: 'Jamf Protect: Detect attempts to dump BTM or being reverted to installation
    defaults'
references:
