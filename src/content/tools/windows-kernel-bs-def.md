...
execution:
  template: sc.exe create Bs_Def.sys binPath=C:\windows\temp\Bs_Def.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create Bs_Def.sys binPath=C:\windows\temp\Bs_Def.sys type=kernel && sc.exe
    start Bs_Def.sys
detections:
- type: yara
