...
name: sslyze
description: Python-based SSL/TLS scanner that analyzes server configurations for
  protocol support, cipher strength, certificate validation, and known vulnerabilities.
...
- name: flag-timeout
  ...
  - --timeout
execution:
  template: sslyze {flag-regular} {flag-certinfo} {flag-sslv2} {flag-sslv3} {flag-tlsv1}
    {flag-tlsv11} {flag-tlsv12} {flag-tlsv13} {flag-starttls} {flag-json} {target}:{port}
  sandbox: execFile
  timeout_seconds: 120
  shell: false
examples:
