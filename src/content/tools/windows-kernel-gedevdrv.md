---
id: windows-kernel-gedevdrv
namespace: windows:kernel:gedevdrv
name: GEDevDrv.SYS
...
execution:
  template: sc.exe create GEDevDrvSYS binPath= C:\windows\temp\GEDevDrvSYS.sys type=kernel
...
install:
- method: custom
  description: Load GEDevDrv.SYS kernel driver
  commands:
  - sc.exe create GEDevDrvSYS binPath= C:\windows\temp\GEDevDrvSYS.sys type=kernel
    && sc.exe start GEDevDrvSYS
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create GEDevDrvSYS binPath= C:\\\\windows\\\\temp\\\\GEDevDrvSYS.sys type=kernel && sc.exe start GEDevDrvSYS"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver GEDevDrv.SYS"
