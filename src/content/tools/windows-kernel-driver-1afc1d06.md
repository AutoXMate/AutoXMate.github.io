---
id: windows-kernel-driver-1afc1d06
namespace: windows:kernel:driver-1afc1d06
name: driver_1afc1d06.sys
...
execution:
  template: sc.exe create driver_bfcbc010.sys binPath=C:\windows\temp\driver_bfcbc010.sys
...
install:
- method: custom
  description: Load driver_1afc1d06.sys kernel driver
  commands:
  - sc.exe create driver_bfcbc010.sys binPath=C:\windows\temp\driver_bfcbc010.sys
    type=kernel && sc.exe start driver_bfcbc010.sys
references:
- label: Reference
...
examples:
  ...
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver driver_1afc1d06.sys"
