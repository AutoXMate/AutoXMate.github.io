---
id: windows-kernel-sepdrv3-1
namespace: windows:kernel:sepdrv3-1
name: sepdrv3_1.sys
...
execution:
  template: sc.exe create sepdrv3_1sys binPath= C:\windows\temp\sepdrv3_1sys.sys type=kernel
...
install:
- method: custom
  description: Load sepdrv3_1.sys kernel driver
  commands:
  - sc.exe create sepdrv3_1sys binPath= C:\windows\temp\sepdrv3_1sys.sys type=kernel
    && sc.exe start sepdrv3_1sys
references:
- label: Reference
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create sepdrv3_1sys binPath= C:\\\\windows\\\\temp\\\\sepdrv3_1sys.sys type=kernel && sc.exe start sepdrv3_1sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver sepdrv3_1.sys"
