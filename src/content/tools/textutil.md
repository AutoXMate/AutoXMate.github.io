...
detections:
  - type: other
    description: "Command Line Argument Detection (args contain textutil AND (-convert OR -stdin OR pbpaste))"
references:
  - label: "textutil"
