...
execution:
  template: sc.exe create tboflhelper binPath=C:\windows\temp\tboflhelper.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create tboflhelper binPath=C:\windows\temp\tboflhelper.sys type=kernel
    && sc.exe start tboflhelper
references:
- label: Reference
