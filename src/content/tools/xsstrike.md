...
name: xsstrike
description: Advanced XSS detection suite with context-aware payload generation, WAF
  detection/evasion, and DOM XSS scanning.
...
- description: Use proxy and custom headers
  command: 'python3 xsstrike.py -u "http://target.com/page.php?q=test" --proxy "http://127.0.0.1:8080"
