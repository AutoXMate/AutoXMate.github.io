...
execution:
  template: sc.exe create viragt.sys binPath=C:\windows\temp\viragt.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create viragt.sys binPath=C:\windows\temp\viragt.sys type=kernel && sc.exe
    start viragt.sys
detections:
- type: yara
