...
execution:
  template: sc.exe create spwizimgVT.sys binPath=C:\windows\temp\spwizimgVT.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create spwizimgVT.sys binPath=C:\windows\temp\spwizimgVT.sys type=kernel
    && sc.exe start spwizimgVT.sys
references:
- label: Reference
