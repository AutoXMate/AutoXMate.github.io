...
execution:
  template: sc.exe create Se64a.sys binPath=C:\windows\temp\Se64a.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create Se64a.sys binPath=C:\windows\temp\Se64a.sys type=kernel && sc.exe
    start Se64a.sys
detections:
- type: yara
