...
execution:
  template: sc.exe create vmdrv.sys binPath=C:\windows\temp\vmdrv.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create vmdrv.sys binPath=C:\windows\temp\vmdrv.sys type=kernel && sc.exe
    start vmdrv.sys
detections:
- type: yara
