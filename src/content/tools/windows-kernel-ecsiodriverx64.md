---
id: windows-kernel-ecsiodriverx64
namespace: windows:kernel:ecsiodriverx64
name: ecsiodriverx64.sys
...
execution:
  template: sc.exe create ecsiodriverx64sys binPath= C:\windows\temp\ecsiodriverx64sys.sys
...
install:
- method: custom
  description: Load ecsiodriverx64.sys kernel driver
  commands:
  - sc.exe create ecsiodriverx64sys binPath= C:\windows\temp\ecsiodriverx64sys.sys
    type=kernel && sc.exe start ecsiodriverx64sys
references:
- label: Reference
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create ecsiodriverx64sys binPath= C:\\\\windows\\\\temp\\\\ecsiodriverx64sys.sys type=kernel && sc.exe start ecsiodriverx64sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver ecsiodriverx64.sys"
