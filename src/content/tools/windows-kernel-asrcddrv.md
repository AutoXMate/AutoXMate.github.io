...
execution:
  template: "sc.exe create AsrCDDrv binPath=C:\\windows\\temp\\AsrCDDrv.sys type=kernel && sc.exe start AsrCDDrv"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
  - method: custom
    ...
    commands:
      - "sc.exe create AsrCDDrv binPath=C:\\windows\\temp\\AsrCDDrv.sys type=kernel && sc.exe start AsrCDDrv"
references:
  - label: "Reference"
