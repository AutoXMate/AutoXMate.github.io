...
execution:
  template: sc.exe create wantd_5.sys binPath=C:\windows\temp\wantd_5.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create wantd_5.sys binPath=C:\windows\temp\wantd_5.sys type=kernel && sc.exe
    start wantd_5.sys
detections:
- type: yara
