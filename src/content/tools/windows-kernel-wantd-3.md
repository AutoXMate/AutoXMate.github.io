...
execution:
  template: sc.exe create wantd_3.sys binPath=C:\windows\temp\wantd_3.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create wantd_3.sys binPath=C:\windows\temp\wantd_3.sys type=kernel && sc.exe
    start wantd_3.sys
detections:
- type: yara
