---
id: windows-kernel-rtport
namespace: windows:kernel:rtport
name: rtport.sys
...
execution:
  template: sc.exe create rtportsys binPath= C:\windows\temp\rtportsys.sys type=kernel
...
install:
- method: custom
  description: Load rtport.sys kernel driver
  commands:
  - sc.exe create rtportsys binPath= C:\windows\temp\rtportsys.sys type=kernel &&
    sc.exe start rtportsys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create rtportsys binPath= C:\\\\windows\\\\temp\\\\rtportsys.sys type=kernel && sc.exe start rtportsys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver rtport.sys"
