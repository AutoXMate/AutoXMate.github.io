...
execution:
  template: "sc.exe create cpqsysio binPath=C:\\windows\\temp\\cpqsysio64.sys type=kernel && sc.exe start cpqsysio"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
