---
id: windows-kernel-sbiosio64
namespace: windows:kernel:sbiosio64
name: SBIOSIO64.sys
...
execution:
  template: sc.exe create SBIOSIO64sys binPath= C:\windows\temp\SBIOSIO64sys.sys type=kernel
...
install:
- method: custom
  description: Load SBIOSIO64.sys kernel driver
  commands:
  - sc.exe create SBIOSIO64sys binPath= C:\windows\temp\SBIOSIO64sys.sys type=kernel
    && sc.exe start SBIOSIO64sys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create SBIOSIO64sys binPath= C:\\\\windows\\\\temp\\\\SBIOSIO64sys.sys type=kernel && sc.exe start SBIOSIO64sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver SBIOSIO64.sys"
