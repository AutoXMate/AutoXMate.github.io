---
id: windows-kernel-typelibde
namespace: windows:kernel:typelibde
name: typelibdE.sys
...
execution:
  template: sc.exe create typelibdE.sys binPath=C:\windows\temp\typelibdE.sys type=kernel
...
install:
- method: custom
  description: Load typelibdE.sys kernel driver
  commands:
  - sc.exe create typelibdE.sys binPath=C:\windows\temp\typelibdE.sys type=kernel
    && sc.exe start typelibdE.sys
references:
- label: Reference
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create typelibdE.sys binPath=C:\\\\windows\\\\temp\\\\typelibdE.sys type=kernel && sc.exe start typelibdE.sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver typelibdE.sys"
