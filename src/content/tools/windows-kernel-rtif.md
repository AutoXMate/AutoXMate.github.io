---
id: windows-kernel-rtif
namespace: windows:kernel:rtif
name: rtif.sys
...
execution:
  template: sc.exe create rtifsys binPath= C:\windows\temp\rtifsys.sys type=kernel
...
install:
- method: custom
  description: Load rtif.sys kernel driver
  commands:
  - sc.exe create rtifsys binPath= C:\windows\temp\rtifsys.sys type=kernel && sc.exe
    start rtifsys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create rtifsys binPath= C:\\\\windows\\\\temp\\\\rtifsys.sys type=kernel && sc.exe start rtifsys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver rtif.sys"
