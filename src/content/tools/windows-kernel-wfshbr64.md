...
execution:
  template: sc.exe create wfshbr64.sys binPath=C:\windows\temp\wfshbr64.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create wfshbr64.sys binPath=C:\windows\temp\wfshbr64.sys type=kernel &&
    sc.exe start wfshbr64.sys
references:
- label: Reference
