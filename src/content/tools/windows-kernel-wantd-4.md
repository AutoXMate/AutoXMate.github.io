...
execution:
  template: sc.exe create wantd_4.sys binPath=C:\windows\temp\wantd_4.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create wantd_4.sys binPath=C:\windows\temp\wantd_4.sys type=kernel && sc.exe
    start wantd_4.sys
detections:
- type: yara
