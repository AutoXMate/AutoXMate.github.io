---
id: windows-kernel-ngiodriver
namespace: windows:kernel:ngiodriver
name: ngiodriver.sys
...
execution:
  template: sc.exe create ngiodriversys binPath= C:\windows\temp\ngiodriversys.sys
...
install:
- method: custom
  description: Load ngiodriver.sys kernel driver
  commands:
  - sc.exe create ngiodriversys binPath= C:\windows\temp\ngiodriversys.sys type=kernel
    && sc.exe start ngiodriversys
detections:
- type: yara
...
examples:
  ...
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver ngiodriver.sys"
