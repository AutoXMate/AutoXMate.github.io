...
execution:
  template: sc.exe create lsigetwin_SliffDriver binPath=C:\windows\temp\lsigetwin_SliffDriver.sys
...
- method: custom
  ...
  commands:
  - sc.exe create lsigetwin_SliffDriver binPath=C:\windows\temp\lsigetwin_SliffDriver.sys
    type=kernel && sc.exe start lsigetwin_SliffDriver
references:
- label: Reference
