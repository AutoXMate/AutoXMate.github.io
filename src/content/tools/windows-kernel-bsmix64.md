...
execution:
  template: sc.exe create BSMIx64.sys binPath=C:\windows\temp\BSMIx64.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create BSMIx64.sys binPath=C:\windows\temp\BSMIx64.sys type=kernel && sc.exe
    start BSMIx64.sys
detections:
- type: yara
