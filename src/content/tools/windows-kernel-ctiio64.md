...
execution:
  template: sc.exe create CtiIo64.sys binPath=C:\windows\temp\CtiIo64.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create CtiIo64.sys binPath=C:\windows\temp\CtiIo64.sys type=kernel && sc.exe
    start CtiIo64.sys
detections:
- type: yara
