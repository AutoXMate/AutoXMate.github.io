...
execution:
  template: sc.exe create NTIOLib.sys binPath=C:\windows\temp\NTIOLib.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create NTIOLib.sys binPath=C:\windows\temp\NTIOLib.sys type=kernel && sc.exe
    start NTIOLib.sys
detections:
- type: yara
