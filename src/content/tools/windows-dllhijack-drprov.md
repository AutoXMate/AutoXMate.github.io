...
id: windows-dllhijack-drprov
namespace: windows:dllhijack:drprov
name: drprov.dll
description: "drprov.dll — Environment Variable hijacking (Microsoft)"
...
references:
  ...
  - label: "HijackLibs"
    url: "https://hijacklibs.net/entries/drprov.html"
---
examples:
  - description: "Place malicious drprov.dll in the search order location"
    command: "copy malicious.dll \"%SYSTEM32%\\drprov.dll\""
