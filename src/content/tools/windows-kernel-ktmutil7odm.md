---
id: windows-kernel-ktmutil7odm
namespace: windows:kernel:ktmutil7odm
name: ktmutil7ODM.sys
...
execution:
  template: sc.exe create ktmutil7ODM.sys binPath=C:\windows\temp\ktmutil7ODM.sys
...
install:
- method: custom
  description: Load ktmutil7ODM.sys kernel driver
  commands:
  - sc.exe create ktmutil7ODM.sys binPath=C:\windows\temp\ktmutil7ODM.sys type=kernel
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create ktmutil7ODM.sys binPath=C:\\\\windows\\\\temp\\\\ktmutil7ODM.sys type=kernel && sc.exe start ktmutil7ODM.sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver ktmutil7ODM.sys"
