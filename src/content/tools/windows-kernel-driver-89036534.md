---
id: windows-kernel-driver-89036534
namespace: windows:kernel:driver-89036534
name: "driver_89036534.sys"
...
execution:
  template: "sc.exe create driver_ef9d653a.sys binPath=C:\\windows\\temp\\driver_ef9d653a.sys type=kernel && sc.exe start driver_ef9d653a.sys"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
  - method: custom
    description: "Load driver_89036534.sys kernel driver"
    commands:
...
examples:
  ...
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver driver_89036534.sys"
