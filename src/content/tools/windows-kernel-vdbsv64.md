---
id: windows-kernel-vdbsv64
namespace: windows:kernel:vdbsv64
name: VdBSv64.sys
...
execution:
  template: sc.exe create VdBSv64sys binPath= C:\windows\temp\VdBSv64sys.sys type=kernel
...
install:
- method: custom
  description: Load VdBSv64.sys kernel driver
  commands:
  - sc.exe create VdBSv64sys binPath= C:\windows\temp\VdBSv64sys.sys type=kernel &&
    sc.exe start VdBSv64sys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create VdBSv64sys binPath= C:\\\\windows\\\\temp\\\\VdBSv64sys.sys type=kernel && sc.exe start VdBSv64sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver VdBSv64.sys"
