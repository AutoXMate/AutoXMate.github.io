...
name: dotdotpwn
description: Directory traversal fuzzing tool that tests for path traversal vulnerabilities
  in web applications and services via HTTP, FTP, and TFTP protocols.
...
- name: flag-cookie
  ...
  - --cookie
execution:
  template: dotdotpwn {flag-protocol} {flag-port} {flag-depth} {flag-os} {flag-file}
    {flag-threads} {flag-dictionary} {flag-cookie} {flag-output} {flag-url} -m {target}
  sandbox: execFile
  timeout_seconds: 300
  shell: false
examples:
