---
id: windows-kernel-sysconp
namespace: windows:kernel:sysconp
name: sysconp.sys
...
execution:
  template: sc.exe create sysconpsys binPath= C:\windows\temp\sysconpsys.sys type=kernel
...
install:
- method: custom
  description: Load sysconp.sys kernel driver
  commands:
  - sc.exe create sysconpsys binPath= C:\windows\temp\sysconpsys.sys type=kernel &&
    sc.exe start sysconpsys
references:
- label: Reference
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create sysconpsys binPath= C:\\\\windows\\\\temp\\\\sysconpsys.sys type=kernel && sc.exe start sysconpsys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver sysconp.sys"
