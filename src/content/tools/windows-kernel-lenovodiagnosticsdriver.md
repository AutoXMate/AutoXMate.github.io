...
execution:
  template: "sc.exe create LenovoDiagnosticsDriver.sys binPath=C:\\windows\\temp\\LenovoDiagnosticsDriver.sys type=kernel && sc.exe start LenovoDiagnosticsDriver.sys"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
