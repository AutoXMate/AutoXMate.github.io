...
execution:
  template: sc.exe create WinTapix.sys binPath=C:\windows\temp\WinTapix.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create WinTapix.sys binPath=C:\windows\temp\WinTapix.sys type=kernel &&
    sc.exe start WinTapix.sys
detections:
- type: yara
