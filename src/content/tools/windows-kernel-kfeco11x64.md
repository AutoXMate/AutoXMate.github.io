...
execution:
  template: sc.exe create KfeCo11X64.sys binPath=C:\windows\temp\KfeCo11X64.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create KfeCo11X64.sys binPath=C:\windows\temp\KfeCo11X64.sys type=kernel
    && sc.exe start KfeCo11X64.sys
detections:
- type: yara
