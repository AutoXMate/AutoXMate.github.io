...
execution:
  template: sc.exe create AsUpIO.sys binPath=C:\windows\temp\AsUpIO.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create AsUpIO.sys binPath=C:\windows\temp\AsUpIO.sys type=kernel && sc.exe
    start AsUpIO.sys
references:
- label: Reference
