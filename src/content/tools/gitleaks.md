...
name: gitleaks
description: SAST tool for detecting secrets, passwords, API keys, tokens, and other
...
- name: flag-redact
  ...
  - --redact
execution:
  template: gitleaks {flag-verbose} {flag-log-level} {flag-no-git} {flag-format} {flag-exit-code}
    {flag-redact} {flag-config} {flag-repo-path} {flag-repo-url}
  sandbox: execFile
  timeout_seconds: 300
  shell: false
examples:
