---
id: windows-kernel-sysinfodetectorx64
namespace: windows:kernel:sysinfodetectorx64
name: SysInfoDetectorX64.sys
...
execution:
  template: sc.exe create SysInfoDetectorX64sys binPath= C:\windows\temp\SysInfoDetectorX64sys.sys
...
install:
- method: custom
  description: Load SysInfoDetectorX64.sys kernel driver
  commands:
  - sc.exe create SysInfoDetectorX64sys binPath= C:\windows\temp\SysInfoDetectorX64sys.sys
    type=kernel && sc.exe start SysInfoDetectorX64sys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create SysInfoDetectorX64sys binPath= C:\\\\windows\\\\temp\\\\SysInfoDetectorX64sys.sys type=kernel && sc.exe start SysInfoDetectorX64sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver SysInfoDetectorX64.sys"
