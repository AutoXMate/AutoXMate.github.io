...
execution:
  ...
  shell: false
examples:
- description: 'Collect system DEP information.: The following command determines
    whether device is DEP(Device Enrolment Program) enabled and output the DEP information.'
  command: sudo profiles show -type enrollment
- description: 'Remove configuration profiles.: The following command deletes the
    specified profiles. An optional password used when removing a configuration profile
