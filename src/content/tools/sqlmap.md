...
name: sqlmap
description: Automatic SQL injection detection and exploitation tool with support
  for all major DBMS and injection techniques.
...
- description: With POST data and cookie
  command: sqlmap -u "http://target.com/login" --data "user=admin&pass=test" --cookie
