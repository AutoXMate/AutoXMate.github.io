---
id: windows-kernel-nvoclock
namespace: windows:kernel:nvoclock
name: nvoclock.sys
...
execution:
  template: sc.exe create nvoclocksys binPath= C:\windows\temp\nvoclocksys.sys type=kernel
...
install:
- method: custom
  description: Load nvoclock.sys kernel driver
  commands:
...
examples:
  ...
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver nvoclock.sys"
