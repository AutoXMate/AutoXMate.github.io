...
name: sslscan
description: Fast C-based TLS/SSL scanner that checks protocol support, cipher suites,
  certificate information, and performs comprehensive server configuration analysis.
...
- name: flag-sni
  ...
  - --sni
execution:
  template: sslscan {flag-xml} {flag-xmlfile} {flag-no-colour} {flag-no-heartbleed}
    {flag-ssl2} {flag-ssl3} {flag-tls10} {flag-tls11} {flag-tls12} {flag-tls13} {flag-starttls}
    {flag-sni} {target}
  sandbox: execFile
  timeout_seconds: 120
  shell: false
