...
execution:
  template: sc.exe create Lv561av.sys binPath=C:\windows\temp\Lv561av.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create Lv561av.sys binPath=C:\windows\temp\Lv561av.sys type=kernel && sc.exe
    start Lv561av.sys
detections:
- type: yara
