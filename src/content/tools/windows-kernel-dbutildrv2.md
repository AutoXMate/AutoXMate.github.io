...
execution:
  template: "sc.exe create DBUtilDrv2.sys binPath=C:\\windows\\temp\\DBUtilDrv2.sys type=kernel && sc.exe start DBUtilDrv2.sys"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
