---
id: windows-kernel-atlaccess
namespace: windows:kernel:atlaccess
name: atlAccess.sys
...
execution:
  template: sc.exe create atlAccesssys binPath= C:\windows\temp\atlAccesssys.sys type=kernel
...
install:
- method: custom
  description: Load atlAccess.sys kernel driver
  commands:
  - sc.exe create atlAccesssys binPath= C:\windows\temp\atlAccesssys.sys type=kernel
    && sc.exe start atlAccesssys
references:
- label: Reference
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create atlAccesssys binPath= C:\\\\windows\\\\temp\\\\atlAccesssys.sys type=kernel && sc.exe start atlAccesssys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver atlAccess.sys"
