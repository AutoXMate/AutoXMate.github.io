---
id: windows-kernel-radhwmgr
namespace: windows:kernel:radhwmgr
name: RadHwMgr.sys
...
execution:
  template: sc.exe create RadHwMgrsys binPath= C:\windows\temp\RadHwMgrsys.sys type=kernel
...
install:
- method: custom
  description: Load RadHwMgr.sys kernel driver
  commands:
  - sc.exe create RadHwMgrsys binPath= C:\windows\temp\RadHwMgrsys.sys type=kernel
    && sc.exe start RadHwMgrsys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create RadHwMgrsys binPath= C:\\\\windows\\\\temp\\\\RadHwMgrsys.sys type=kernel && sc.exe start RadHwMgrsys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver RadHwMgr.sys"
