...
execution:
  template: sc.exe create gmer64.sys binPath=C:\windows\temp\gmer64.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create gmer64.sys binPath=C:\windows\temp\gmer64.sys type=kernel && sc.exe
    start gmer64.sys
detections:
- type: yara
