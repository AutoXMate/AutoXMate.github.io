...
execution:
  template: sc.exe create SysInfo.sys binPath=C:\windows\temp\SysInfo.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create SysInfo.sys binPath=C:\windows\temp\SysInfo.sys type=kernel && sc.exe
    start SysInfo.sys
references:
- label: Reference
