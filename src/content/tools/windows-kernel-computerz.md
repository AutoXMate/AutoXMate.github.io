---
id: windows-kernel-computerz
namespace: windows:kernel:computerz
name: ComputerZ.Sys
...
execution:
  template: sc.exe create ComputerZSys binPath= C:\windows\temp\ComputerZSys.sys type=kernel
...
install:
- method: custom
  description: Load ComputerZ.Sys kernel driver
  commands:
  - sc.exe create ComputerZSys binPath= C:\windows\temp\ComputerZSys.sys type=kernel
    && sc.exe start ComputerZSys
detections:
- type: yara
...
- label: Reference
  url: https://github.com/magicsword-io/LOLDrivers/issues/304
features:
- file-system
- local
- pipes-stdin
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create ComputerZSys binPath= C:\\\\windows\\\\temp\\\\ComputerZSys.sys type=kernel && sc.exe start ComputerZSys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver ComputerZ.Sys"
