---
id: windows-kernel-wirwadrv
namespace: windows:kernel:wirwadrv
name: WiRwaDrv.sys
...
execution:
  template: sc.exe create WiRwaDrvsys binPath= C:\windows\temp\WiRwaDrvsys.sys type=kernel
...
install:
- method: custom
  description: Load WiRwaDrv.sys kernel driver
  commands:
  - sc.exe create WiRwaDrvsys binPath= C:\windows\temp\WiRwaDrvsys.sys type=kernel
    && sc.exe start WiRwaDrvsys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create WiRwaDrvsys binPath= C:\\\\windows\\\\temp\\\\WiRwaDrvsys.sys type=kernel && sc.exe start WiRwaDrvsys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver WiRwaDrv.sys"
