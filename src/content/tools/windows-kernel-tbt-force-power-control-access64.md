...
execution:
  template: "sc.exe create TBT_Force_Power_Control_Access64 binPath=C:\\windows\\temp\\TBT_Force_Power_Control_Access64.sys type=kernel && sc.exe start TBT_Force_Power_Control_Access64"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
