---
id: windows-kernel-fpcie2com
namespace: windows:kernel:fpcie2com
name: FPCIE2COM.sys
...
execution:
  template: sc.exe create FPCIE2COMsys binPath= C:\windows\temp\FPCIE2COMsys.sys type=kernel
...
install:
- method: custom
  description: Load FPCIE2COM.sys kernel driver
  commands:
  - sc.exe create FPCIE2COMsys binPath= C:\windows\temp\FPCIE2COMsys.sys type=kernel
    && sc.exe start FPCIE2COMsys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create FPCIE2COMsys binPath= C:\\\\windows\\\\temp\\\\FPCIE2COMsys.sys type=kernel && sc.exe start FPCIE2COMsys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver FPCIE2COM.sys"
