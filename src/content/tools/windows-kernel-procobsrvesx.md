...
execution:
  template: sc.exe create ProcObsrvesx binPath=C:\windows\temp\ProcObsrvesx.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create ProcObsrvesx binPath=C:\windows\temp\ProcObsrvesx.sys type=kernel
    && sc.exe start ProcObsrvesx
references:
- label: Reference
