...
description: "IUForceDelete.sys is a vulnerable kernel driver from the KeServiceDescriptorTable/vulnerable-drivers repository. The driver exposes dangerous kernel primitives to usermode."
author: "Michael Haag"
version: "1.0.0"
capabilities:
...
execution:
  template: "sc.exe create IUForceDelete binPath=C:\\windows\\temp\\IUForceDelete.sys type=kernel && sc.exe start IUForceDelete"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
