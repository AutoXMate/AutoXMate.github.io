...
name: "hp64vision.sys"
description: "hp64vision.sys is a vulnerable kernel driver from the KeServiceDescriptorTable/vulnerable-drivers repository. The driver exposes dangerous kernel primitives to usermode."
author: "Michael Haag"
version: "1.0.0"
capabilities:
...
execution:
  template: "sc.exe create hp64vision binPath=C:\\windows\\temp\\hp64vision.sys type=kernel && sc.exe start hp64vision"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
