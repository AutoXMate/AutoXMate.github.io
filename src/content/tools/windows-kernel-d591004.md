...
name: d591004.sys
description: d591004.sys is a vulnerable kernel driver from the KeServiceDescriptorTable/vulnerable-drivers
...
execution:
  template: sc.exe create d591004 binPath=C:\windows\temp\d591004.sys type=kernel
    && sc.exe start d591004
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
- method: custom
  ...
  commands:
  - sc.exe create d591004 binPath=C:\windows\temp\d591004.sys type=kernel && sc.exe
    start d591004
references:
- label: Reference
