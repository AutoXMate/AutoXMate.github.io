...
id: windows-dllhijack-vsstrace
namespace: windows:dllhijack:vsstrace
name: vsstrace.dll
description: vsstrace.dll — Sideloading hijacking (Microsoft)
...
- label: HijackLibs
  url: https://hijacklibs.net/entries/vsstrace.html
features:
- requires-root
---

examples:
  - description: "Place malicious vsstrace.dll in the search order location"
    command: "copy malicious.dll \"%SYSTEM32%\\vsstrace.dll\""
