...
execution:
  ...
  shell: false
examples:
- description: 'Export local host users: Export the local host user information to
    a file'
  command: dsexport local_users.txt /Local/Default dsRecTypeStandard:Users
- description: 'Export local host groups: Export the local host group information
    to a file'
