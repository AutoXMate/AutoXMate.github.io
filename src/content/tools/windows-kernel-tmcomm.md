...
execution:
  template: sc.exe create TmComm.sys binPath=C:\windows\temp\TmComm.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create TmComm.sys binPath=C:\windows\temp\TmComm.sys type=kernel && sc.exe
    start TmComm.sys
detections:
- type: yara
