...
execution:
  template: sc.exe create GtcKmdfBssys binPath= C:\windows\temp\GtcKmdfBssys.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create GtcKmdfBssys binPath= C:\windows\temp\GtcKmdfBssys.sys type=kernel
    && sc.exe start GtcKmdfBssys
detections:
- type: yara
