...
execution:
  template: sc.exe create RwDrv.sys binPath=C:\windows\temp\RwDrv.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create RwDrv.sys binPath=C:\windows\temp\RwDrv.sys type=kernel && sc.exe
    start RwDrv.sys
detections:
- type: yara
