...
execution:
  ...
  shell: false
examples:
- description: 'Enable safaridriver: The following command can be used to enable the
    WebDriver Safari browser API. The command must be run as root or with sudo privileges.'
