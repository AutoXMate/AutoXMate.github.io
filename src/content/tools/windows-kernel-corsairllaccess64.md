...
execution:
  template: sc.exe create CorsairLLAccess64.sys binPath=C:\windows\temp\CorsairLLAccess64.sys
...
- method: custom
  ...
  commands:
  - sc.exe create CorsairLLAccess64.sys binPath=C:\windows\temp\CorsairLLAccess64.sys
    type=kernel && sc.exe start CorsairLLAccess64.sys
detections:
- type: yara
