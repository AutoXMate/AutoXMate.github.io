...
execution:
  template: sc.exe create Lurker.sys binPath=C:\windows\temp\Lurker.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create Lurker.sys binPath=C:\windows\temp\Lurker.sys type=kernel && sc.exe
    start Lurker.sys
references:
- label: Reference
