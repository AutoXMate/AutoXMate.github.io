...
execution:
  template: sc.exe create GGProtect64 binPath=C:\windows\temp\GGProtect64.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create GGProtect64 binPath=C:\windows\temp\GGProtect64.sys type=kernel
    && sc.exe start GGProtect64
references:
- label: Reference
