...
execution:
  template: sc.exe create AsmIo64.sys binPath=C:\windows\temp\AsmIo64.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create AsmIo64.sys binPath=C:\windows\temp\AsmIo64.sys type=kernel && sc.exe
    start AsmIo64.sys
detections:
- type: yara
