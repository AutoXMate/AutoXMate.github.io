...
execution:
  template: sc.exe create malicious.sys binPath=C:\windows\temp\malicious.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create malicious.sys binPath=C:\windows\temp\malicious.sys type=kernel
    && sc.exe start malicious.sys
references:
- label: Reference
