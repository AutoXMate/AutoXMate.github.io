...
description: "Chaos-Rootkit is a x64 ring0 rootkit with process hiding, privilege escalation, and capabilities for protecting and unprotecting processes, work on the latest Windows versions."
author: "Michael Haag"
version: "1.0.0"
capabilities:
...
execution:
  template: "sc.exe create Chaos-Rootkit.sys binPath=C:\\windows\\temp\\Chaos-Rootkit.sys type=kernel && sc.exe start Chaos-Rootkit.sys"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
