---
id: windows-kernel-driver-a6deeea6
namespace: windows:kernel:driver-a6deeea6
name: "driver_a6deeea6.sys"
...
execution:
  template: "sc.exe create driver_d9f15d91.sys binPath=C:\\windows\\temp\\driver_d9f15d91.sys type=kernel && sc.exe start driver_d9f15d91.sys"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
  - method: custom
    description: "Load driver_a6deeea6.sys kernel driver"
    commands:
...
examples:
  ...
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver driver_a6deeea6.sys"
