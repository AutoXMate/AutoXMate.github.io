...
- description: POST injection with custom headers
  command: 'ghauri -u "http://target.com/login" --data "user=admin&pass=test" --headers
    "X-Forwarded-For: 127.0.0.1"'
- description: High risk scan through proxy
  command: ghauri -u "http://target.com/page?id=1" --level 3 --risk 3 --proxy http://127.0.0.1:8080
    --batch
references:
- label: Ghauri GitHub
