---
id: windows-kernel-smarteio64
namespace: windows:kernel:smarteio64
name: SMARTEIO64.SYS
...
execution:
  template: sc.exe create SMARTEIO64SYS binPath= C:\windows\temp\SMARTEIO64SYS.sys
...
install:
- method: custom
  description: Load SMARTEIO64.SYS kernel driver
  commands:
  - sc.exe create SMARTEIO64SYS binPath= C:\windows\temp\SMARTEIO64SYS.sys type=kernel
    && sc.exe start SMARTEIO64SYS
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create SMARTEIO64SYS binPath= C:\\\\windows\\\\temp\\\\SMARTEIO64SYS.sys type=kernel && sc.exe start SMARTEIO64SYS"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver SMARTEIO64.SYS"
