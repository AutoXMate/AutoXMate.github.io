...
description: "chinese_cheat_driver.sys is a vulnerable kernel driver from the KeServiceDescriptorTable/vulnerable-drivers repository. The driver exposes dangerous kernel primitives to usermode."
author: "Michael Haag"
version: "1.0.0"
capabilities:
...
execution:
  template: "sc.exe create chinese_cheat_driver binPath=C:\\windows\\temp\\chinese_cheat_driver.sys type=kernel && sc.exe start chinese_cheat_driver"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
