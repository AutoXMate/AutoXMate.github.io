...
name: hcxpcaptool
description: Converts packet capture files to hash formats compatible with hashcat
  and john for WPA cracking.
...
- description: Full extraction of all data
  command: hcxpcaptool -z hash.22000 -E essids.txt -I identities.txt -U usernames.txt
    capture.pcapng
references:
