...
execution:
  template: "sc.exe create DriversCloud_amd64 binPath=C:\\windows\\temp\\DriversCloud_amd64.sys type=kernel && sc.exe start DriversCloud_amd64"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
