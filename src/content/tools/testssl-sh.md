...
name: testssl.sh
description: Shell script for TLS/SSL testing that checks protocol support, cipher
  suites, certificate issues, and known vulnerabilities on any TLS server.
...
- name: flag-ciphers
  ...
  - --ciphers
execution:
  template: testssl.sh {flag-quiet} {flag-color} {flag-severity} {flag-protocols}
    {flag-ciphers} {flag-json} {flag-html} {flag-csv} {flag-starttls} {target}
  sandbox: execFile
  timeout_seconds: 300
  shell: false
examples:
