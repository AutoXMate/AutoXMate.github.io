...
execution:
  template: sc.exe create kerneldamd64 binPath= C:\windows\temp\kerneldamd64.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create kerneldamd64 binPath= C:\windows\temp\kerneldamd64.sys type=kernel
    && sc.exe start kerneldamd64
references:
- label: Reference
