---
id: windows-kernel-avalueio
namespace: windows:kernel:avalueio
name: avalueio.sys
...
execution:
  template: sc.exe create avalueiosys binPath= C:\windows\temp\avalueiosys.sys type=kernel
...
install:
- method: custom
  description: Load avalueio.sys kernel driver
  commands:
  - sc.exe create avalueiosys binPath= C:\windows\temp\avalueiosys.sys type=kernel
    && sc.exe start avalueiosys
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create avalueiosys binPath= C:\\\\windows\\\\temp\\\\avalueiosys.sys type=kernel && sc.exe start avalueiosys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver avalueio.sys"
