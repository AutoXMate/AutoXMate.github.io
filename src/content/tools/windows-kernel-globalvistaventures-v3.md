...
description: "GlobalVistaVentures_v3.sys is a vulnerable kernel driver from the KeServiceDescriptorTable/vulnerable-drivers repository. The driver exposes dangerous kernel primitives to usermode."
author: "Michael Haag"
version: "1.0.0"
capabilities:
...
execution:
  template: "sc.exe create GlobalVistaVentures_v3 binPath=C:\\windows\\temp\\GlobalVistaVentures_v3.sys type=kernel && sc.exe start GlobalVistaVentures_v3"
  sandbox: execFile
  timeout_seconds: 30
  shell: true
install:
