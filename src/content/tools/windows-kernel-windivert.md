...
execution:
  template: sc.exe create windivert.sys binPath=C:\windows\temp\windivert.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create windivert.sys binPath=C:\windows\temp\windivert.sys type=kernel
    && sc.exe start windivert.sys
references:
- label: Reference
