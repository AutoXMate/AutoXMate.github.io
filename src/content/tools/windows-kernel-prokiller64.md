...
execution:
  template: sc.exe create prokiller64.sys binPath=C:\windows\temp\prokiller64.sys
...
- method: custom
  ...
  commands:
  - sc.exe create prokiller64.sys binPath=C:\windows\temp\prokiller64.sys type=kernel
