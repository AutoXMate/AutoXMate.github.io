...
execution:
  template: sc.exe create LgCoreTemp.sys binPath=C:\windows\temp\LgCoreTemp.sys     type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create LgCoreTemp.sys binPath=C:\windows\temp\LgCoreTemp.sys     type=kernel
    && sc.exe start LgCoreTemp.sys
detections:
- type: yara
