...
execution:
  template: sc.exe create gameink.sys binPath=C:\windows\temp\gameink.sys type=kernel
...
- method: custom
  ...
  commands:
  - sc.exe create gameink.sys binPath=C:\windows\temp\gameink.sys type=kernel && sc.exe
    start gameink.sys
references:
- label: Reference
