---
id: windows-kernel-tdeio64
namespace: windows:kernel:tdeio64
name: tdeio64.sys
...
execution:
  template: sc.exe create tdeio64sys binPath= C:\windows\temp\tdeio64sys.sys type=kernel
...
install:
- method: custom
  description: Load tdeio64.sys kernel driver
  commands:
  - sc.exe create tdeio64sys binPath= C:\windows\temp\tdeio64sys.sys type=kernel &&
    sc.exe start tdeio64sys
references:
- label: Reference
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create tdeio64sys binPath= C:\\\\windows\\\\temp\\\\tdeio64sys.sys type=kernel && sc.exe start tdeio64sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver tdeio64.sys"
