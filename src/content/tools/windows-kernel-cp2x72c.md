---
id: windows-kernel-cp2x72c
namespace: windows:kernel:cp2x72c
name: CP2X72C.SYS
...
execution:
  template: sc.exe create CP2X72CSYS binPath= C:\windows\temp\CP2X72CSYS.sys type=kernel
...
install:
- method: custom
  description: Load CP2X72C.SYS kernel driver
  commands:
  - sc.exe create CP2X72CSYS binPath= C:\windows\temp\CP2X72CSYS.sys type=kernel &&
    sc.exe start CP2X72CSYS
detections:
- type: yara
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create CP2X72CSYS binPath= C:\\\\windows\\\\temp\\\\CP2X72CSYS.sys type=kernel && sc.exe start CP2X72CSYS"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver CP2X72C.SYS"
