...
execution:
  ...
  shell: false
examples:
- description: 'Ad-hoc codesigning an app bundle: This command forcefully re-signs
    the MyApp.app application with an ad-hoc signature, applying the signature deeply
    to all nested code within the app'
