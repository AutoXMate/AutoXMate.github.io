---
id: windows-kernel-834761775
namespace: windows:kernel:834761775
name: 834761775.sys
...
execution:
  template: sc.exe create 834761775.sys binPath=C:\windows\temp\834761775.sys type=kernel
...
install:
- method: custom
  description: Load 834761775.sys kernel driver
  commands:
  - sc.exe create 834761775.sys binPath=C:\windows\temp\834761775.sys type=kernel
    && sc.exe start 834761775.sys
references:
- label: Reference
...
examples:
  - description: "Load the kernel driver"
    command: "sc.exe create 834761775.sys binPath=C:\\\\windows\\\\temp\\\\834761775.sys type=kernel && sc.exe start 834761775.sys"
  - description: "Exploit the driver for privilege escalation"
    command: "Exploit.exe --driver 834761775.sys"
