...
name: kadimus
description: LFI (Local File Inclusion) scanning and exploitation tool that detects
  file inclusion vulnerabilities and leverages them for RCE and file reading.
...
- name: flag-proxy
  ...
  - --proxy
execution:
  template: kadimus {flag-scan} {flag-parameter} {flag-command} {flag-data} {flag-cookie}
    {flag-user-agent} {flag-proxy} -u {url}
  sandbox: execFile
  timeout_seconds: 120
  shell: false
examples:
