...
execution:
  template: sc.exe create BdApiUtil64.sys binPath=C:\windows\temp\BdApiUtil64.sys
...
- method: custom
  ...
  commands:
  - sc.exe create BdApiUtil64.sys binPath=C:\windows\temp\BdApiUtil64.sys type=kernel
