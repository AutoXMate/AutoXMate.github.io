...
execution:
  template: sc.exe create iscflashx64.sys binPath=C:\windows\temp\iscflashx64.sys
...
- method: custom
  ...
  commands:
  - sc.exe create iscflashx64.sys binPath=C:\windows\temp\iscflashx64.sys type=kernel
