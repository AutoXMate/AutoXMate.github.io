...
name: crlfuzz
description: Fast CRLF injection scanner written in Go that detects HTTP response
  splitting and header injection vulnerabilities.
...
- name: flag-concurrency
  ...
  - --concurrency
execution:
  template: crlfuzz {flag-verbose} {flag-threads} {flag-timeout} {flag-concurrency}
    {flag-output} {target}
  sandbox: execFile
  timeout_seconds: 120
  shell: false
