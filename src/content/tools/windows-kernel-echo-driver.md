...
execution:
  template: sc.exe create echo_driver.sys binPath=C:\windows\temp\echo_driver.sys
...
- method: custom
  ...
  commands:
  - sc.exe create echo_driver.sys binPath=C:\windows\temp\echo_driver.sys type=kernel
